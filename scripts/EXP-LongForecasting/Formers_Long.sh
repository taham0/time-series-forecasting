...
do
  ...
  python -u run_longExp.py \
      --is_training 0 \
      --root_path ./dataset/ \
      --data_path electricity_shuf.csv \
      ...
      --c_out 321 \
      --des 'Exp' \
      --itr 1 >logs/LongForecasting/$model_name'_electricity_shuf_'$pred_len.log

  python -u run_longExp.py \
      --is_training 0 \
      --root_path ./dataset/ \
      --data_path appliances_shuf.csv \
      --model_id appliances_96_$pred_len \
      --model $model_name \
      --data custom \
      --features MS \
      --seq_len 96 \
      ...
      --c_out 27 \
      --des 'Exp' \
      --itr 1 >logs/LongForecasting/$model_name'_appliances_shuf_'$pred_len.log  \
      --target 'Appliances'
  ...
  python -u run_longExp.py \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 2 >logs/LongForecasting/$model_name'_weather_shuf_'$pred_len.log
